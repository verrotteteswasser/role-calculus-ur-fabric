...
% ---------- Language & Encoding ----------
% \usepackage[T1]{fontenc}      % <- ENTFERNEN/auskommentieren mit LuaLaTeX
% \usepackage[utf8]{inputenc}   % <- ENTFERNEN/auskommentieren mit LuaLaTeX
\usepackage{fontspec}           % <- NEU
...
% WICHTIG: beide Ordner erlauben (du hast figures/fig/)
\graphicspath{{figures/}{figures/fig/}}
% Optional: während Bilder fehlen
...
\newif\ifdraft
\draftfalse
\ifdraft \usepackage{todonotes} \else \usepackage[disable]{todonotes} \fi
...
% Backward-compat für alte Fontbefehle (KOMA-safe)
